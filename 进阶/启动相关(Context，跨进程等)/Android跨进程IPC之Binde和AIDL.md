[TOC]
- <!-- TOC -->
- [ Android跨进程IPC之Binde和AIDL](#Android跨进程IPC之Binde和AIDL)
  - [ 参考文章](#参考文章)
  - [ 一、前言](#一前言)
    - [ 1.1 Liunx相关知识](#11-Liunx相关知识)
      - [ 1.1.1 Liunx进程空间划分](#111-Liunx进程空间划分)
      - [ 1.1.2内存映射](#112内存映射)
    - [ 1.2 IPC的定义](#12-IPC的定义)
    - [ 1.3 Android中IPC常用的方式及优缺点](#13-Android中IPC常用的方式及优缺点)
    - [ 1.4 Binder机制定义](#14-Binder机制定义)
    - [ 1.5 AIDL定义](#15-AIDL定义)
    - [ 1.6 应用多进程](#16-应用多进程)
      - [ 1.6.1 特点](#161-特点)
      - [ 1.6.2 应用多进程存在的问题](#162-应用多进程存在的问题)
  - [ 二、Binder概述](#二Binder概述)
    - [ 2.1 Android为什么选择Binder](#21-Android为什么选择Binder)
    - [ 2.2 Binder通信模型](#22-Binder通信模型)
    - [ 2.3 模型通讯流程](#23-模型通讯流程)
    - [ 2.4 模型通讯原理](#24-模型通讯原理)
    - [ 2.5 Binder对象和Binder驱动](#25-Binder对象和Binder驱动)
    - [ 2.6 Java层的Binder](#26-Java层的Binder)
    - [ 2.7 Binder跨进程概述图](#27-Binder跨进程概述图)
    - [ 2.8 Android开发之AIDL](#28-Android开发之AIDL)
  - [ 三、AIDL](#三AIDL)
    - [ 3.1 AIDL支持的数据类型](#31-AIDL支持的数据类型)
    - [ 3.2 AIDL实例](#32-AIDL实例)
    - [ 3.3 实例说明](#33-实例说明)
      - [ 3.3.1 DESCRIPTION](#331-DESCRIPTION)
      - [ 3.3.2 asInterface()](#332-asInterface)
      - [ 3.3.3 asBinder](#333-asBinder)
      - [ 3.3.4 onTransact()](#334-onTransact)
      - [ 3.3.5 ProxygetBookList](#335-ProxygetBookList)
      - [ 3.3.6 ProxyaddBook](#336-ProxyaddBook)
  - [ 四、Messenger](#四Messenger)
    - [ 4.1 说明](#41-说明)
